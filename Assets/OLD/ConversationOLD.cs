...
public enum SpeakerType { None, Nadira, Mika, Harlan, Noah, Kenny, Lily }

[CreateAssetMenu(fileName ="New Convo")]
public class ConversationOLD : ScriptableObject
{
    [System.Serializable]
    public class Line
    {
        ...
        {
            public SpeakerType speaker = SpeakerType.None;
            public int index = -1;
